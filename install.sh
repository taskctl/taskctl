#!/bin/sh
set -e
# Code generated by godownloader on 2020-05-03T12:08:54Z. DO NOT EDIT.
#

usage() {
  this=$1
  cat <<EOF
$this: download go binaries for taskctl/taskctl

Usage: $this [-b] bindir [-d] [tag]
  -b sets bindir or installation directory, Defaults to ./bin
  -d turns on debug logging
   [tag] is a tag from
   https://github.com/taskctl/taskctl/releases
